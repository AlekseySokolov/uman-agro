...
import presentation from './Презентация ГК ЮМАН.pdf';
  ...
  render() {
    return (
      ...
      <div className="jumbotron top">
        ...
        <h1 className="display-6 text-center" style={{fontSize : '3vh', color:"#ff4444", fontWeight : "bold", marginTop : "3vmin"}}>Производство и поставка зерна по всей России</h1>
        <br />
        ...
        <p className="lead text-center">
          <a className="btn btn-danger btn-lg" style={{fontSize : '1.8vh', marginTop : "2vmin"}} href={presentation} role="button" >Скачать презентацию</a>
        </p>
      </div>
    </div>
    );
